...
public class Keys {
    ...
    public static final UniqueKey<ChatLinkRecord> CONSTRAINT_8 = Internal.createUniqueKey(ChatLink.CHAT_LINK,
        ...
        new TableField[] {ChatLink.CHAT_LINK.CHAT_ID, ChatLink.CHAT_LINK.URL_ID},
        true
    );
    public static final UniqueKey<LinkRecord> CONSTRAINT_2 =
        Internal.createUniqueKey(Link.LINK, DSL.name("CONSTRAINT_2"), new TableField[] {Link.LINK.URL_ID}, true);
    ...
    public static final ForeignKey<ChatLinkRecord, LinkRecord> CONSTRAINT_868 =
        Internal.createForeignKey(ChatLink.CHAT_LINK,
            ...
            new TableField[] {ChatLink.CHAT_LINK.URL_ID},
            Keys.CONSTRAINT_2,
            new TableField[] {Link.LINK.URL_ID},
            true
        );
}
