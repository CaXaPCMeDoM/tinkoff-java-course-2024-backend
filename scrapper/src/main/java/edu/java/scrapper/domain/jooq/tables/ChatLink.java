...
public class ChatLink extends TableImpl<ChatLinkRecord> {
    ...
    /**
     * The column <code>CHAT_LINK.URL_ID</code>.
     */
    public final TableField<ChatLinkRecord, Long> URL_ID = createField(DSL.name("URL_ID"), SQLDataType.BIGINT.nullable(false), this, "");
